...
R_Gandhi.DF <- data.frame(read.csv("C:/Users/User/Desktop/Project JK/english #RahulGandhi.csv", header = TRUE))
R_Gandhi.DF
...
write.csv(R_Gandhi.DF,"C:/Users/User/Desktop/Project JK/R_Gandhi.DF.csv", row.names = FALSE)
